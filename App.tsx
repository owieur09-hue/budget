...
const App: React.FC = () => {
  ...
  const renderHeader = () => {
    ...
    return (
      <header className="flex-none px-6 pt-10 pb-6 bg-black text-white flex justify-between items-end z-10 rounded-b-[2.5rem] shadow-xl min-h-[130px] box-border">
  ...
  return (
    <div className="flex flex-col w-full max-w-md mx-auto bg-white overflow-hidden relative shadow-2xl" style={{ height: 'calc(var(--vh, 1vh) * 100)' }}>
      {renderHeader()}

      {/* 메인 영역: 스크롤 복구 및 가로 밀림 방지 */}
      <main className="flex-1 overflow-y-auto overflow-x-hidden bg-white pb-24 touch-pan-y relative">
      ...
      {/* 하단 바 */}
      <div className="flex-none bg-white border-t border-gray-100 z-50">
